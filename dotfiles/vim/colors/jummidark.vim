...
hi Normal ctermfg=254 ctermbg=none cterm=NONE guifg=#e4e4e4 guibg=#000000 gui=NONE
...
hi Type ctermfg=177 ctermbg=NONE cterm=NONE guifg=#af5fff guibg=NONE gui=NONE
hi Directory ctermfg=177 ctermbg=NONE cterm=NONE guifg=#af5fff guibg=NONE gui=NONE
hi Tag ctermfg=177 ctermbg=NONE cterm=NONE guifg=#af5fff guibg=NONE gui=NONE
hi String ctermfg=177 ctermbg=NONE cterm=NONE guifg=#af5fff guibg=NONE gui=NONE
...
hi Comment ctermfg=119 ctermbg=NONE cterm=Italic guifg=#4e4e4e guibg=NONE gui=NONE
hi NonText ctermfg=119 ctermbg=NONE cterm=NONE guifg=#4e4e4e guibg=NONE gui=NONE
...
" Search Highlight
hi Search ctermfg=119 ctermbg=124 cterm=NONE guifg=NONE guibg=#3a3a3a gui=NONE
hi IncSearch ctermfg=NONE ctermbg=237 cterm=NONE guifg=NONE guibg=#3a3a3a gui=NONE

" Special Comment
hi SpecialComment ctermfg=119 ctermbg=235 cterm=NONE guifg=#6c6c6c guibg=#262626 gui=NONE
...
hi LineNr ctermfg=118 ctermbg=None cterm=NONE guifg=#8a8a8a guibg=#303030 gui=NONE
hi ColorLineNr ctermfg=15 ctermbg=236 cterm=NONE guifg=#FFFFFF guibg=#303030 gui=NONE
hi CursorLine ctermfg=None ctermbg=242 cterm=underline guifg=NONE guibg=#1c1c1c gui=NONE
hi CursorLineNr ctermfg=208 ctermbg=None cterm=NONE guifg=#af8700 guibg=#303030 gui=NONE
hi CursorColumn ctermfg=0 ctermbg=0 cterm=inverse guifg=#e4e4e4 guibg=#383838 gui=NONE
"" 254 237

"  Select
hi Visual ctermfg=NONE ctermbg=27 cterm=NONE guifg=NONE guibg=#080808 gui=NONE
